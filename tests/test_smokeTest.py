...
class TestDefaultSuite():
  ...
  def test_logoHeaderandTitle(self):
    ...
    self.driver.set_window_size(656, 1047)
  ...
  def test_joinPageDataEntry(self):
    ...
    self.driver.set_window_size(656, 1040)
    elements = self.driver.find_elements(By.NAME, "fname")
    assert len(elements) > 0
    self.driver.find_element(By.NAME, "fname").send_keys("Angela")
    self.driver.find_element(By.NAME, "lname").click()
    self.driver.find_element(By.NAME, "lname").send_keys("Milford")
    self.driver.find_element(By.NAME, "bizname").click()
    self.driver.find_element(By.NAME, "bizname").send_keys("bigblu")
    self.driver.find_element(By.NAME, "biztitle").click()
    self.driver.find_element(By.NAME, "biztitle").send_keys("Ms")
  ...
  def test_adminPageUsernamePassword(self):
    ...
    self.driver.find_element(By.ID, "username").send_keys("angelasmilford")
